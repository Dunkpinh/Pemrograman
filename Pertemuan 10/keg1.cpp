...
void cari_sekuensial_array(int data[], int s, int idxData[], int sidx, int cari[]){
	for(int i = 0; i < sidx; i++){
		idxData[i] = cari_sekuensial(data, 1000, cari[i]);
	}
}
...
int main(){
	...
	isiArray(cari, 10);
	int idxData[10];
	cari_sekuensial_array(data, 1000, idxData, 10, cari);
